...
# List of folder names where the "Difference" folder will be created
folder_names = [
...
for folder_name in folder_names:
    ...
    # Create a folder named "Difference" inside the destination folder
    difference_folder = os.path.join(destination_folder, "Label")
    os.makedirs(difference_folder, exist_ok=True)

print("Difference folders created successfully.")